...
var oderForm = document.getElementById("oderForm");

oderForm.addEventListener('submit', function(){

    event.preventDefault();
    
    var orderTypevalue = event.target.orderType.value;
    console.log(orderTypevalue);

    var quantityvalue = event.target.quantity.value;
    console.log(quantityvalue);

    var locationPlacevalue = event.target.locationPlace.value;
    console.log(locationPlacevalue);

    var chefInfovalue = event.target.chefInfo.value.split(',');
    console.log(chefInfovalue);

    var sendasgiftvalue = event.target.sendasgift.checked;
    console.log(sendasgiftvalue);

    var addflavoronevalue = event.target.addflavorone.checked;
    console.log(addflavoronevalue);

    var addflavorthreevalue = event.target.addflavorthree.checked;
    console.log(addflavorthreevalue);
    
    var neworders = new restrantreports(
        orderTypevalue,
        quantityvalue,
        locationPlacevalue,
        chefInfovalue,
